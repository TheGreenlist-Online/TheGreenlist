export const DISTRICTS = [
  ...
  { id: 'cultivators', name: 'Cultivator Grove', description: 'A filtered view of verified cultivator profiles using the shared business directory.', href: '/businesses?business_type=CULTIVATOR', icon: 'trees', position: 'md:col-start-1 md:row-start-3', availability: 'planned' },
